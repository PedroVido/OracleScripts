...
col type form a20
--col Benefit form 999,999,999,999,990
col Benefit FOR 999,999,999,999,990

select * from (
                select b.task_name,
                       b.ATTR1 as SQL_ID,
                       b.TYPE,
                       round(max(a.BENEFIT)) as "Benefit"
                  from DBA_ADVISOR_RECOMMENDATIONS a, 
                       DBA_ADVISOR_OBJECTS b
                 where a.REC_ID = b.OBJECT_ID
                   ...
                   and a.TASK_ID in (select distinct b.task_id
                                      ...
                                      where a.begin_interval_time > sysdate - 7
                                        ...
                                        and a.INSTANCE_NUMBER = (select INSTANCE_NUMBER 
                                                                   from v$instance)
                  ...
                  group by b.task_name,b.ATTR1,b.TYPE
