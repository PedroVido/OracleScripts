...
col sta heading 'STATUS' for a15;

select dest_id, dest_name, DESTINATION, status as sta, database_mode, error, SYNCHRONIZED, GAP_STATUS from v$archive_dest_status where database_mode <> 'UNKNOWN';
prompt
