...
819,168     + 204,792 =  1.023,96   
83,416      + 204,792    288,208      

41471700 + 2048000 = 43519700   
3543652 + 2048000 =  5591652   


set serveroutput on size 10000;

declare 
total_new NUMBER(20) :=  43519700;    --<-- Valor do Disco atual mais o valor que sera adicionado
free_new NUMBER(20) :=  5591652;      --<-- Espaco livre atual mais o valor que sera adicionado
...
dbms_output.put_line('===========================================================================================' );
dbms_output.put_line('===========================================================================================' );
dbms_output.put_line(' =   Novo valor do DATA FREE em GB: ' || free_new ||', Porcentagem free: '                    
                           ||(100 - (ROUND((1- (free_new / total_new))*100, 2)))||'%                      =' );
dbms_output.put_line('===========================================================================================' );
end;
